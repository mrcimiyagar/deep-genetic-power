...
# joblib.dump(svm, 'SvmModel_standard')
svm = joblib.load('SvmModel_standard')

tester = Tester('result_standard')
tester.test_neuron(model, test_x, test_y, batch_size)
tester.test_svm(model, test_x, test_y, batch_size, svm, [scaler_standard])
