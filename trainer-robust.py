...
# joblib.dump(svm, 'SvmModel_robust')
svm = joblib.load('SvmModel_robust')


tester = Tester('result_robust')
tester.test_neuron(model, test_x, test_y, batch_size)
tester.test_svm(model, test_x, test_y, batch_size, svm, [scaler_robust])
